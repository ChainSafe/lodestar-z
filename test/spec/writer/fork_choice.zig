...
// Known conformance gaps in src/fork_choice — these cases fail against the
// current implementation (20 cases as of spec tests v1.7.0-alpha.11).
// Remove entries as the corresponding fork-choice behavior is fixed.
