...
pub fn PublicKey_ctor(env: napi.Env, cb: napi.CallbackInfo(0)) !napi.Value {
    ...
    try env.wrap(cb.this(), PublicKey, pk, PublicKey_finalize, null, null);
    return cb.this();
}
...
pub fn Signature_ctor(env: napi.Env, cb: napi.CallbackInfo(0)) !napi.Value {
    ...
    try env.wrap(cb.this(), Signature, sig, Signature_finalize, null, null);
    return cb.this();
}
...
pub fn SecretKey_ctor(env: napi.Env, cb: napi.CallbackInfo(0)) !napi.Value {
    ...
    try env.wrap(cb.this(), SecretKey, sk, SecretKey_finalize, null, null);
    return cb.this();
}
