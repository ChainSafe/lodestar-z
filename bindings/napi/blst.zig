...
pub fn register(env: napi.Env, exports: napi.Value) !void {
    ...
    const sk_ctor = try env.defineClass(
        ...
        &[_]napi.c.napi_property_descriptor{
            .{ .utf8name = "sign", .method = napi.wrapCallback(1, SecretKey_sign) },
            .{ .utf8name = "toPublicKey", .method = napi.wrapCallback(0, SecretKey_toPublicKey) },
            .{ .utf8name = "toBytes", .method = napi.wrapCallback(0, SecretKey_toBytes) },
        },
    );
    try sk_ctor.defineProperties(&[_]napi.c.napi_property_descriptor{
        .{ .utf8name = "fromBytes", .method = napi.wrapCallback(1, SecretKey_fromBytes) },
        .{ .utf8name = "fromKeygen", .method = napi.wrapCallback(1, SecretKey_fromKeygen) },
    });
    ...
    try pk_ctor.defineProperties(&[_]napi.c.napi_property_descriptor{
        .{ .utf8name = "fromBytes", .method = napi.wrapCallback(1, PublicKey_fromBytes) },
    });
