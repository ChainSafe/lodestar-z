//! JS binding for the `swap_or_not_shuffle` module. The exposed API mirrors
//! the `@chainsafe/swap-or-not-shuffle` npm package exactly: same function
//! names, argument order, return values, and error messages.
