...
| Compact-proof reconstruction workspace | [`createNodeFromCompactMultiProof`](../../src/persistent_merkle_tree/proof.zig) validates descriptor shape, depth, and leaf count before allocating nodes. Reconstruction reads packed descriptor bits with a bounded stack and reclaims unfinished subtrees on failure; it allocates no decoded-descriptor scratch. |
