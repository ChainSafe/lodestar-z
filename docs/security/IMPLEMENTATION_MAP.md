...
| Fixed-element vector hashing workspace | [`FixedVectorType`](../../src/ssz/type/vector.zig) uses at most 64 direct chunks for small vectors and bounded Merkle accumulation for larger vectors. Byte hashing checks the fixed serialized size before reading chunks; child types retain their validation contracts. |
