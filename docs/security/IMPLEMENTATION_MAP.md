...
| Variable-element vector hashing workspace | [`VariableVectorType`](../../src/ssz/type/vector.zig) uses at most 64 direct chunks for small vectors and streams larger vectors into bounded Merkle accumulation. Serialized hashing uses the fallible variable-element iterator; child hashers retain their own allocation and validation contracts. |
