...
pub fn build(b: *std.Build) void {
    ...
    b.modules.put(b.dupe("spec_tests_operations"), module_spec_tests_operations) catch @panic("OOM");

    const test_spec_tests_operations = b.addTest(.{
        .name = "spec_tests_operations",
        .root_module = module_spec_tests_operations,
        .filters = b.option([][]const u8, "spec_tests_operations.filters", "spec_tests_operations test filters") orelse &[_][]const u8{},
    });
    const install_test_spec_tests_operations = b.addInstallArtifact(test_spec_tests_operations, .{});
    const tls_install_test_spec_tests_operations = b.step("build-test:spec_tests_operations", "Install the spec_tests_operations test");
    tls_install_test_spec_tests_operations.dependOn(&install_test_spec_tests_operations.step);

    const run_test_spec_tests_operations = b.addRunArtifact(test_spec_tests_operations);
    const tls_run_test_spec_tests_operations = b.step("test:spec_tests_operations", "Run the spec_tests_operations test");
    tls_run_test_spec_tests_operations.dependOn(&run_test_spec_tests_operations.step);
    ...
    b.modules.put(b.dupe("spec_tests_epoch_processing"), module_spec_tests_epoch_processing) catch @panic("OOM");

    const test_spec_tests_epoch_processing = b.addTest(.{
        .name = "spec_tests_epoch_processing",
        .root_module = module_spec_tests_epoch_processing,
        .filters = b.option([][]const u8, "spec_tests_epoch_processing.filters", "spec_tests_epoch_processing test filters") orelse &[_][]const u8{},
    });
    const install_test_spec_tests_epoch_processing = b.addInstallArtifact(test_spec_tests_epoch_processing, .{});
    const tls_install_test_spec_tests_epoch_processing = b.step("build-test:spec_tests_epoch_processing", "Install the spec_tests_epoch_processing test");
    tls_install_test_spec_tests_epoch_processing.dependOn(&install_test_spec_tests_epoch_processing.step);

    const run_test_spec_tests_epoch_processing = b.addRunArtifact(test_spec_tests_epoch_processing);
    const tls_run_test_spec_tests_epoch_processing = b.step("test:spec_tests_epoch_processing", "Run the spec_tests_epoch_processing test");
    tls_run_test_spec_tests_epoch_processing.dependOn(&run_test_spec_tests_epoch_processing.step);
    ...
    b.modules.put(b.dupe("spec_tests_sanity"), module_spec_tests_sanity) catch @panic("OOM");

    const test_spec_tests_sanity = b.addTest(.{
        .name = "spec_tests_sanity",
        .root_module = module_spec_tests_sanity,
        .filters = b.option([][]const u8, "spec_tests_sanity.filters", "spec_tests_sanity test filters") orelse &[_][]const u8{},
    });
    const install_test_spec_tests_sanity = b.addInstallArtifact(test_spec_tests_sanity, .{});
    const tls_install_test_spec_tests_sanity = b.step("build-test:spec_tests_sanity", "Install the spec_tests_sanity test");
    tls_install_test_spec_tests_sanity.dependOn(&install_test_spec_tests_sanity.step);

    const run_test_spec_tests_sanity = b.addRunArtifact(test_spec_tests_sanity);
    const tls_run_test_spec_tests_sanity = b.step("test:spec_tests_sanity", "Run the spec_tests_sanity test");
    tls_run_test_spec_tests_sanity.dependOn(&run_test_spec_tests_sanity.step);
    ...
    b.modules.put(b.dupe("spec_tests_rewards"), module_spec_tests_rewards) catch @panic("OOM");

    const test_spec_tests_rewards = b.addTest(.{
        .name = "spec_tests_rewards",
        .root_module = module_spec_tests_rewards,
        .filters = b.option([][]const u8, "spec_tests_rewards.filters", "spec_tests_rewards test filters") orelse &[_][]const u8{},
    });
    const install_test_spec_tests_rewards = b.addInstallArtifact(test_spec_tests_rewards, .{});
    const tls_install_test_spec_tests_rewards = b.step("build-test:spec_tests_rewards", "Install the spec_tests_rewards test");
    tls_install_test_spec_tests_rewards.dependOn(&install_test_spec_tests_rewards.step);

    const run_test_spec_tests_rewards = b.addRunArtifact(test_spec_tests_rewards);
    const tls_run_test_spec_tests_rewards = b.step("test:spec_tests_rewards", "Run the spec_tests_rewards test");
    tls_run_test_spec_tests_rewards.dependOn(&run_test_spec_tests_rewards.step);
    ...
    b.modules.put(b.dupe("spec_tests_transition"), module_spec_tests_transition) catch @panic("OOM");

    const test_spec_tests_transition = b.addTest(.{
        .name = "spec_tests_transition",
        .root_module = module_spec_tests_transition,
        .filters = b.option([][]const u8, "spec_tests_transition.filters", "spec_tests_transition test filters") orelse &[_][]const u8{},
    });
    const install_test_spec_tests_transition = b.addInstallArtifact(test_spec_tests_transition, .{});
    const tls_install_test_spec_tests_transition = b.step("build-test:spec_tests_transition", "Install the spec_tests_transition test");
    tls_install_test_spec_tests_transition.dependOn(&install_test_spec_tests_transition.step);

    const run_test_spec_tests_transition = b.addRunArtifact(test_spec_tests_transition);
    const tls_run_test_spec_tests_transition = b.step("test:spec_tests_transition", "Run the spec_tests_transition test");
    tls_run_test_spec_tests_transition.dependOn(&run_test_spec_tests_transition.step);
    ...
    b.modules.put(b.dupe("spec_tests_random"), module_spec_tests_random) catch @panic("OOM");

    const test_spec_tests_random = b.addTest(.{
        .name = "spec_tests_random",
        .root_module = module_spec_tests_random,
        .filters = b.option([][]const u8, "spec_tests_random.filters", "spec_tests_random test filters") orelse &[_][]const u8{},
    });
    const install_test_spec_tests_random = b.addInstallArtifact(test_spec_tests_random, .{});
    const tls_install_test_spec_tests_random = b.step("build-test:spec_tests_random", "Install the spec_tests_random test");
    tls_install_test_spec_tests_random.dependOn(&install_test_spec_tests_random.step);

    const run_test_spec_tests_random = b.addRunArtifact(test_spec_tests_random);
    const tls_run_test_spec_tests_random = b.step("test:spec_tests_random", "Run the spec_tests_random test");
    tls_run_test_spec_tests_random.dependOn(&run_test_spec_tests_random.step);
    ...
    b.modules.put(b.dupe("spec_tests_fork"), module_spec_tests_fork) catch @panic("OOM");

    const test_spec_tests_fork = b.addTest(.{
        .name = "spec_tests_fork",
        .root_module = module_spec_tests_fork,
        .filters = b.option([][]const u8, "spec_tests_fork.filters", "spec_tests_fork test filters") orelse &[_][]const u8{},
    });
    const install_test_spec_tests_fork = b.addInstallArtifact(test_spec_tests_fork, .{});
    const tls_install_test_spec_tests_fork = b.step("build-test:spec_tests_fork", "Install the spec_tests_fork test");
    tls_install_test_spec_tests_fork.dependOn(&install_test_spec_tests_fork.step);

    const run_test_spec_tests_fork = b.addRunArtifact(test_spec_tests_fork);
    const tls_run_test_spec_tests_fork = b.step("test:spec_tests_fork", "Run the spec_tests_fork test");
    tls_run_test_spec_tests_fork.dependOn(&run_test_spec_tests_fork.step);
    ...
    b.modules.put(b.dupe("spec_tests_finality"), module_spec_tests_finality) catch @panic("OOM");

    const test_spec_tests_finality = b.addTest(.{
        .name = "spec_tests_finality",
        .root_module = module_spec_tests_finality,
        .filters = b.option([][]const u8, "spec_tests_finality.filters", "spec_tests_finality test filters") orelse &[_][]const u8{},
    });
    const install_test_spec_tests_finality = b.addInstallArtifact(test_spec_tests_finality, .{});
    const tls_install_test_spec_tests_finality = b.step("build-test:spec_tests_finality", "Install the spec_tests_finality test");
    tls_install_test_spec_tests_finality.dependOn(&install_test_spec_tests_finality.step);

    const run_test_spec_tests_finality = b.addRunArtifact(test_spec_tests_finality);
    const tls_run_test_spec_tests_finality = b.step("test:spec_tests_finality", "Run the spec_tests_finality test");
    tls_run_test_spec_tests_finality.dependOn(&run_test_spec_tests_finality.step);
    ...
    b.modules.put(b.dupe("spec_tests_merkle_proof"), module_spec_tests_merkle_proof) catch @panic("OOM");

    const test_spec_tests_merkle_proof = b.addTest(.{
        .name = "spec_tests_merkle_proof",
        .root_module = module_spec_tests_merkle_proof,
        .filters = b.option([][]const u8, "spec_tests_merkle_proof.filters", "spec_tests_merkle_proof test filters") orelse &[_][]const u8{},
    });
    const install_test_spec_tests_merkle_proof = b.addInstallArtifact(test_spec_tests_merkle_proof, .{});
    const tls_install_test_spec_tests_merkle_proof = b.step("build-test:spec_tests_merkle_proof", "Install the spec_tests_merkle_proof test");
    tls_install_test_spec_tests_merkle_proof.dependOn(&install_test_spec_tests_merkle_proof.step);

    const run_test_spec_tests_merkle_proof = b.addRunArtifact(test_spec_tests_merkle_proof);
    const tls_run_test_spec_tests_merkle_proof = b.step("test:spec_tests_merkle_proof", "Run the spec_tests_merkle_proof test");
    tls_run_test_spec_tests_merkle_proof.dependOn(&run_test_spec_tests_merkle_proof.step);
    tls_run_test.dependOn(&run_test_spec_tests_merkle_proof.step);
    ...
    module_spec_tests_operations.addImport("spec_test_options", options_module_spec_test_options);
    module_spec_tests_operations.addImport("consensus_types", module_consensus_types);
    module_spec_tests_operations.addImport("config", module_config);
    module_spec_tests_operations.addImport("fork_types", module_fork_types);
    module_spec_tests_operations.addImport("preset", module_preset);
    module_spec_tests_operations.addImport("snappy", dep_snappy.module("snappy"));
    module_spec_tests_operations.addImport("state_transition", module_state_transition);
    module_spec_tests_operations.addImport("ssz", module_ssz);
    module_spec_tests_operations.addImport("bls", module_bls);
    module_spec_tests_operations.addImport("persistent_merkle_tree", module_persistent_merkle_tree);
    module_spec_tests_operations.addImport("hex", module_hex);

    module_spec_tests_epoch_processing.addImport("spec_test_options", options_module_spec_test_options);
    module_spec_tests_epoch_processing.addImport("consensus_types", module_consensus_types);
    module_spec_tests_epoch_processing.addImport("config", module_config);
    module_spec_tests_epoch_processing.addImport("fork_types", module_fork_types);
    module_spec_tests_epoch_processing.addImport("preset", module_preset);
    module_spec_tests_epoch_processing.addImport("snappy", dep_snappy.module("snappy"));
    module_spec_tests_epoch_processing.addImport("state_transition", module_state_transition);
    module_spec_tests_epoch_processing.addImport("ssz", module_ssz);
    module_spec_tests_epoch_processing.addImport("bls", module_bls);
    module_spec_tests_epoch_processing.addImport("persistent_merkle_tree", module_persistent_merkle_tree);
    module_spec_tests_epoch_processing.addImport("hex", module_hex);

    module_spec_tests_sanity.addImport("spec_test_options", options_module_spec_test_options);
    module_spec_tests_sanity.addImport("consensus_types", module_consensus_types);
    module_spec_tests_sanity.addImport("config", module_config);
    module_spec_tests_sanity.addImport("fork_types", module_fork_types);
    module_spec_tests_sanity.addImport("preset", module_preset);
    module_spec_tests_sanity.addImport("snappy", dep_snappy.module("snappy"));
    module_spec_tests_sanity.addImport("state_transition", module_state_transition);
    module_spec_tests_sanity.addImport("ssz", module_ssz);
    module_spec_tests_sanity.addImport("bls", module_bls);
    module_spec_tests_sanity.addImport("persistent_merkle_tree", module_persistent_merkle_tree);
    module_spec_tests_sanity.addImport("hex", module_hex);

    module_spec_tests_rewards.addImport("spec_test_options", options_module_spec_test_options);
    module_spec_tests_rewards.addImport("consensus_types", module_consensus_types);
    module_spec_tests_rewards.addImport("config", module_config);
    module_spec_tests_rewards.addImport("fork_types", module_fork_types);
    module_spec_tests_rewards.addImport("preset", module_preset);
    module_spec_tests_rewards.addImport("snappy", dep_snappy.module("snappy"));
    module_spec_tests_rewards.addImport("state_transition", module_state_transition);
    module_spec_tests_rewards.addImport("ssz", module_ssz);
    module_spec_tests_rewards.addImport("bls", module_bls);
    module_spec_tests_rewards.addImport("persistent_merkle_tree", module_persistent_merkle_tree);
    module_spec_tests_rewards.addImport("hex", module_hex);

    module_spec_tests_transition.addImport("spec_test_options", options_module_spec_test_options);
    module_spec_tests_transition.addImport("consensus_types", module_consensus_types);
    module_spec_tests_transition.addImport("config", module_config);
    module_spec_tests_transition.addImport("fork_types", module_fork_types);
    module_spec_tests_transition.addImport("preset", module_preset);
    module_spec_tests_transition.addImport("snappy", dep_snappy.module("snappy"));
    module_spec_tests_transition.addImport("state_transition", module_state_transition);
    module_spec_tests_transition.addImport("ssz", module_ssz);
    module_spec_tests_transition.addImport("bls", module_bls);
    module_spec_tests_transition.addImport("persistent_merkle_tree", module_persistent_merkle_tree);
    module_spec_tests_transition.addImport("hex", module_hex);

    module_spec_tests_random.addImport("spec_test_options", options_module_spec_test_options);
    module_spec_tests_random.addImport("consensus_types", module_consensus_types);
    module_spec_tests_random.addImport("config", module_config);
    module_spec_tests_random.addImport("fork_types", module_fork_types);
    module_spec_tests_random.addImport("preset", module_preset);
    module_spec_tests_random.addImport("snappy", dep_snappy.module("snappy"));
    module_spec_tests_random.addImport("state_transition", module_state_transition);
    module_spec_tests_random.addImport("ssz", module_ssz);
    module_spec_tests_random.addImport("bls", module_bls);
    module_spec_tests_random.addImport("persistent_merkle_tree", module_persistent_merkle_tree);
    module_spec_tests_random.addImport("hex", module_hex);

    module_spec_tests_fork.addImport("spec_test_options", options_module_spec_test_options);
    module_spec_tests_fork.addImport("consensus_types", module_consensus_types);
    module_spec_tests_fork.addImport("config", module_config);
    module_spec_tests_fork.addImport("fork_types", module_fork_types);
    module_spec_tests_fork.addImport("preset", module_preset);
    module_spec_tests_fork.addImport("snappy", dep_snappy.module("snappy"));
    module_spec_tests_fork.addImport("state_transition", module_state_transition);
    module_spec_tests_fork.addImport("ssz", module_ssz);
    module_spec_tests_fork.addImport("bls", module_bls);
    module_spec_tests_fork.addImport("persistent_merkle_tree", module_persistent_merkle_tree);
    module_spec_tests_fork.addImport("hex", module_hex);

    module_spec_tests_finality.addImport("spec_test_options", options_module_spec_test_options);
    module_spec_tests_finality.addImport("consensus_types", module_consensus_types);
    module_spec_tests_finality.addImport("config", module_config);
    module_spec_tests_finality.addImport("fork_types", module_fork_types);
    module_spec_tests_finality.addImport("preset", module_preset);
    module_spec_tests_finality.addImport("snappy", dep_snappy.module("snappy"));
    module_spec_tests_finality.addImport("state_transition", module_state_transition);
    module_spec_tests_finality.addImport("ssz", module_ssz);
    module_spec_tests_finality.addImport("bls", module_bls);
    module_spec_tests_finality.addImport("persistent_merkle_tree", module_persistent_merkle_tree);
    module_spec_tests_finality.addImport("hex", module_hex);

    module_spec_tests_merkle_proof.addImport("spec_test_options", options_module_spec_test_options);
    module_spec_tests_merkle_proof.addImport("consensus_types", module_consensus_types);
    module_spec_tests_merkle_proof.addImport("config", module_config);
    module_spec_tests_merkle_proof.addImport("fork_types", module_fork_types);
    module_spec_tests_merkle_proof.addImport("preset", module_preset);
    module_spec_tests_merkle_proof.addImport("snappy", dep_snappy.module("snappy"));
    module_spec_tests_merkle_proof.addImport("state_transition", module_state_transition);
    module_spec_tests_merkle_proof.addImport("ssz", module_ssz);
    module_spec_tests_merkle_proof.addImport("bls", module_bls);
    module_spec_tests_merkle_proof.addImport("persistent_merkle_tree", module_persistent_merkle_tree);
    module_spec_tests_merkle_proof.addImport("hex", module_hex);
