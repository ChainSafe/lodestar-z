...
pub const AnyBeaconState = union(ForkSeq) {
    ...
    pub fn latestExecutionPayloadHeader(self: *AnyBeaconState, allocator: Allocator, out: *ExecutionPayloadHeader) !void {
        return switch (self.*) {
    ...
    pub fn setLatestExecutionPayloadHeader(self: *AnyBeaconState, header: *const ExecutionPayloadHeader) !void {
        switch (self.*) {
