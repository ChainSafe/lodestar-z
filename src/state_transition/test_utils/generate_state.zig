...
const ElectraBeaconState = ct.electra.BeaconState.Type;
...
pub fn generateElectraState(allocator: Allocator, chain_config: ChainConfig, validator_count: usize) !*BeaconStateAllForks {
    ...
    electra_state.* = ct.electra.BeaconState.default_value;
    ...
    // finality
    electra_state.justification_bits = ct.phase0.JustificationBits.default_value;
    for (0..4) |i| {
