...
const ETH_TO_GWEI: u64 = preset.EFFECTIVE_BALANCE_INCREMENT;
...
pub fn computeWeakSubjectivityPeriodFromConstituentsPhase0(
    ...
    // totalBalanceByIncrement = totalBalance / MAX_EFFECTIVE_BALANCE, MAX_EFFECTIVE_BALANCE == ETH_TO_GWEI atm.
    ...
    if (lhs < rhs) {
        ...
        // Realistically, t < T will almost never happen. Napkin math:
        //
        // T = 32, t ∈ [0, 32]
        //
        // if T - t = 0, then lhs = 32 * 230 = 7360 < rhs = 32 * 320 = 10240,
        // so we will never enter the else branch.
        //
