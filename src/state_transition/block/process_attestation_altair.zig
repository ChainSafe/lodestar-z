...
/// AT = AttestationType
/// for phase0 it's `ct.phase0.Attestation.Type`
/// for electra it's `ct.electra.Attestation.Type`
...
pub fn getAttestationParticipationStatus(state: *const BeaconStateAllForks, data: ct.phase0.AttestationData.Type, inclusion_delay: u64, current_epoch: Epoch, root_cache: *RootCache) !u8 {
